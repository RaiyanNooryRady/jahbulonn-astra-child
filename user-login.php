...
<section class="page-section login-page">
    <div class="full-width-screen">
        <div class="container-fluid">
          ...
          <img style="width:300px; height: 150px;" src="<?php echo get_theme_file_uri(); ?>/assets/images/logo.png" alt="logo" class="avatar">
        </div>
                    <div class="input-control">
                        ...
                        <div class="login-with-btns">
                            <span class="already-acc">Not a member? <a href="<?php echo esc_url(get_permalink(get_page_by_path('user-register'))); ?>" class="signup-btn">Sign up</a></span>
                        </div>
                    </div>
