            ...
            <div class="content-detail">
                ...
                <form class="signup-form" method="post">
                    ...
                    <div class="imgcontainer">
                        <img style="width:400px; height: 150px;" src="<?php echo get_theme_file_uri(); ?>/assets/images/logo.png" alt="logo" class="img-fluid avatar">
                    </div>
                    <div class="input-control">
                        ...
                        <div class="login-with-btns">
                          <span class="already-acc">Already you have an account? <a href="<?php echo esc_url(get_permalink(get_page_by_path('login'))); ?>" class="login-btn">Login</a></span>
                        </div>
                    </div>
                </form>
            </div>
